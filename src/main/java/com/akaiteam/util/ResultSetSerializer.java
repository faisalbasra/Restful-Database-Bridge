...
/**
 * Created by Zeeshan Ahmad on 4/20/2016.
 */
public class ResultSetSerializer extends JsonSerializer<ResultSet> {
    ...
    @Override
    public void serialize(ResultSet rs, JsonGenerator jgen, SerializerProvider provider) throws IOException, ResultSetSerializerException {
